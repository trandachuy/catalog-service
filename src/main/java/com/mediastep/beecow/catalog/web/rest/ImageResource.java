...
import com.mediastep.beecow.catalog.service.ImageService;
...
public class ImageResource {
    ...
    public ResponseEntity<ImageDTO> createImage(@RequestBody ImageDTO imageDTO) throws URISyntaxException {
        ...
        if (imageDTO.getId() != null) {
            return ResponseEntity.badRequest().headers(
                HeaderUtil.createFailureAlert(CatalogServicesApp.class.getSimpleName(), false, ENTITY_NAME, "idexists", "A new image cannot already have an ID")
            ).body(null);
        }
    ...
    public ResponseEntity<ImageDTO> updateImage(@RequestBody ImageDTO imageDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(CatalogServicesApp.class.getSimpleName(), false, ENTITY_NAME, imageDTO.getId().toString()))
            .body(result);
    }
