...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "catalogServices@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "catalogServices API";

        private String description = "catalogServices API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "catalogServices";
